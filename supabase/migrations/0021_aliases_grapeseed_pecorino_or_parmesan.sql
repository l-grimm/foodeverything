-- 0021_aliases_grapeseed_pecorino_or_parmesan.sql
--
-- Recipes routinely list two interchangeable options as a single
-- ingredient name ("1/2 cup pecorino or parmesan, grated"). Treat the
-- combined string as the more common choice for matching purposes.
--
-- - grapeseed oil joins the canola/vegetable bucket (neutral oils)
-- - "vegetable or grapeseed oil" / "grapeseed or vegetable oil" -> canola
-- - "pecorino or parmesan" / "parmesan or pecorino" -> parmesan cheese
--
-- Standalone "pecorino" is still NOT aliased — it's a distinct cheese
-- when explicitly called for. Only the either/or phrase collapses.
