-- 0013_aliases_parmesan.sql
--
-- Italian-vs-English parmesan aliases. Recipes spell it half a dozen ways
-- (parmigiano, parmigiano-reggiano, parm, grated parmesan); pantry just
-- says "parmesan cheese". Collapse them all to that canonical form.
--
-- Intentionally NOT included: pecorino, grana padano, asiago — those are
-- distinct cheeses, not interchangeable with parmesan in a recipe.
