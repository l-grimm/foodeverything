-- 0023_aliases_thyme_parmigiano_reggiano_cheese_espelette.sql
--
-- - "thyme leaves" -> "thyme" (alias key is post-strip "thyme leave");
--   "fresh thyme" -> "thyme" while we're there.
-- - "parmigiano reggiano cheese" -> parmesan cheese. Already had
--   "parmigiano reggiano" and "parmigiano cheese" but the user's recipes
--   are turning up the full three-word form.
-- - piment d'espelette / espelette pepper -> red pepper flake. French
--   chili, milder and fruitier than crushed red pepper, but the user
--   treats them interchangeably for pantry purposes.
