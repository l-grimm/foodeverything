-- 0027_alias_green_onion_scallion.sql
--
-- green onion -> scallion. Same plant, two names depending on region;
-- "scallion" is the canonical here. Plural strip covers "green onions"
-- and "scallions" automatically.
