-- 0020_aliases_cumin_coriander_unified.sql
--
-- Treat cumin and coriander as separate spices (each with multiple forms)
-- rather than cross-aliased. Replaces the previous cumin seed -> coriander
-- seed cross-alias from migration 0015.
--
-- All cumin forms collapse to "cumin":
--   cumin seed / ground cumin / whole cumin -> cumin
-- All coriander forms collapse to "coriander":
--   coriander seed / ground coriander / whole coriander -> coriander
