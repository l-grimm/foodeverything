-- 0017_aliases_beef_chuck_coarse_salt_ground_pepper.sql
--
-- - beef chuck roast / beef roast / chuck roast -> beef chuck.
--   Recipes name the cut + form ("chuck roast"); pantry just tracks "beef
--   chuck" as the cut.
-- - coarse salt joins the existing salt bucket.
-- - "ground pepper" + the previously-aliased "freshly ground black pepper"
--   / "ground black pepper" all collapse to "pepper" (assumed staple).
--   Previously these were going to "black pepper", a separate staple
--   entry — both are in the staple list so coverage works either way,
--   but consolidating to "pepper" is cleaner.
