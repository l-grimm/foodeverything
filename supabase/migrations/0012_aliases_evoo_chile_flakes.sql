-- 0012_aliases_evoo_chile_flakes.sql
--
-- Two more high-volume real-world variants from the corpus:
--
-- 1. "extra-virgin olive oil" / "extra virgin olive oil" / "EVOO" /
--    "virgin olive oil" all collapse to "olive oil". 91 + 28 occurrences
--    of the extra-virgin variants alone.
--
-- 2. "chile flake" / "chili flake" / "chilli flake" (all three spellings)
--    plus the "red ___" prefixed variants and "crushed red pepper" all
--    collapse to the canonical "red pepper flake".
--
-- "garlic cloves" already normalizes correctly (plural strip + alias) so
-- no change needed for that — user verified.
