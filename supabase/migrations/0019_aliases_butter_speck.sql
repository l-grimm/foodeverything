-- 0019_aliases_butter_speck.sql
--
-- - unsalted butter / salted butter -> butter. Salt level is a recipe
--   adjustment, not a different ingredient for pantry purposes.
-- - pancetta -> speck. Distinct cured pork products technically (pancetta
--   is salt-cured belly, speck is smoked dry-cured Tyrolean) but the user
--   treats them interchangeably in their kitchen.
