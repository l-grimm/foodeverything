-- 0016_aliases_stock_cucumber_hotpepper_milk.sql
--
-- Four more user-flagged aliases:
--
-- - chicken bouillon -> chicken stock. Bouillon is concentrated, stock
--   is liquid, but functionally interchangeable for matching purposes.
-- - english cucumber -> cucumber. Variety, treated as the base.
-- - hot pepper sauce -> hot sauce. Joins buffalo sauce in the
--   already-existing hot-sauce bucket.
-- - whole milk / skim milk -> milk. Fat percentage doesn't affect
--   pantry matching for the user.
