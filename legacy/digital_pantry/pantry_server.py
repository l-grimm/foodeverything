...
TIKTOK_AIRTABLE_TOKEN = os.getenv("AIRTABLE_API_KEY")
TIKTOK_AIRTABLE_BASE_ID = os.getenv("AIRTABLE_BASE_ID")
TIKTOK_AIRTABLE_TABLE = os.getenv("AIRTABLE_TABLE_NAME")

table = Table(TIKTOK_AIRTABLE_TOKEN, TIKTOK_AIRTABLE_BASE_ID, TIKTOK_AIRTABLE_TABLE)
